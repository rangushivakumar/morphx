...
const contactDetails = [
  {
    icon: Phone,
    title: "Phone",
    content: "+1 (512) 456-3654",
    link: "tel:+15124563654",
  },
  {
    icon: Mail,
    title: "Email",
    content: "hello@leanbuildllc.com",
    link: "mailto:hello@leanbuildllc.com",
  },
  {
    icon: MapPin,
    title: "Headquarters",
    content: "8751 Collin McKinney PkwySuite 1102 #542, McKinney, TX 75070",
    link: null,
  },
  {
    icon: Clock,
...
<a
  href="https://www.google.com/maps/search/?api=1&query=8751+Collin+McKinney+Pkwy+Suite+1102+%23542,+McKinney,+TX+75070"
  target="_blank"
  rel="noopener noreferrer"
  className="block"
>
  <div className="relative aspect-video bg-card/65 backdrop-blur-sm border border-border/80 rounded-xl overflow-hidden shadow-md group hover:border-primary/20 hover:shadow-lg transition-all duration-500 cursor-pointer">
    ...
    <div className="absolute bottom-4 left-4 z-20 bg-background/90 border border-border px-3.5 py-2 rounded-lg shadow-sm">
      <p className="text-xs font-semibold text-foreground">
        McKinney, Texas Headquarters
      </p>
      <p className="text-[10px] text-muted-foreground mt-0.5">
        8751 Collin McKinney Pkwy, Suite 1102 #542
      </p>
    </div>

    {/* Optional Hover Text */}
    <div className="absolute top-4 right-4 z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
      <span className="bg-background/90 border border-border px-2 py-1 rounded text-[10px] font-medium">
        Open Maps
      </span>
    </div>
  </div>
